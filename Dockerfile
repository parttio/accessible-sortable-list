...
COPY --from=BUILD /app/accessible-sortable-list-demo/target/accessible-sortable-list-demo-1.0-SNAPSHOT.jar /app/
WORKDIR /app/
EXPOSE 8080
ENTRYPOINT java -jar accessible-sortable-list-demo-1.0-SNAPSHOT.jar 8080